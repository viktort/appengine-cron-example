...
cd $HOME/$CIRCLE_PROJECT_REPONAME && $HOME/appengine-java-sdk-1.9.46/bin/appcfg.sh -A $GCLOUD_PROJECT -V 4 --service_account_json_key_file=account.json update target/appengine-try-java-1.0
